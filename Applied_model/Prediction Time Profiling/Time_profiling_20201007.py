...
class pr:
    ...
    def SA_SS_single_it(self, Nc, x, b_i, Am, XX, d, tolSSSA, exit_flag):
        ...
        if type(Z) == bool:
            # Use ANN lnphi
            #ln_phi_x = self.ln_phi_model_calc(a_mix, b_mix, b_i, sum_xiAij)
            # Use npANN lnphi, numba for prediction.
            #ln_phi_x = self.ln_phi_model_calc_np(a_mix, b_mix, b_i, sum_xiAij)
            # Use npnbANN ln_phi, numba everywhere
            ln_phi_x = self.ln_phi_model_calc_npnb(a_mix, b_mix, b_i, sum_xiAij,
                                                   self.min_attr_nC4, self.range_attr_nC4,
                                                   self.range_label_nC4, self.min_label_nC4, self.min_attr_nC10, self.range_attr_nC10, self.range_label_nC10,
                                                   self.min_label_nC10,
                                                   self.nC4_w0, self.nC4_w1, self.nC4_w2, self.nC4_w3, self.nC4_w4, self.nC4_b0, self.nC4_b1, self.nC4_b2,
                                                   self.nC4_b3, self.nC4_b4,
                                                   self.nC10_w0, self.nC10_w1, self.nC10_w2, self.nC10_w3, self.nC10_w4, self.nC10_b0, self.nC10_b1,
                                                   self.nC10_b2, self.nC10_b3, self.nC10_b4
                                                   )
    ...
    def stability_analysis(self, T, P, z, b_i, Am, tolSSSA, itSSSAmax, Nc, K, TolXz):
        ...
        # PROFILING
        # Warm up
        X_warmup = np.array([0.096363940, 0.231393959, 0.228188976, 0.098272932], dtype=np.float64)
        y_hat_nC10 = self.npnb_ANN_predict(X_warmup,
                                           self.nC10_w0,
                                           self.nC10_w1,
                                           self.nC10_w2,
                                           self.nC10_w3,
        ...
        ln_phi_x = self.ln_phi_model_calc_npnb(a_mix, b_mix, b_i, sum_xiAij,
                                               self.min_attr_nC4, self.range_attr_nC4,
                                               self.range_label_nC4, self.min_label_nC4, self.min_attr_nC10,
                                               self.range_attr_nC10, self.range_label_nC10,
                                               self.min_label_nC10,
                                               self.nC4_w0, self.nC4_w1, self.nC4_w2, self.nC4_w3, self.nC4_w4,
                                               self.nC4_b0, self.nC4_b1, self.nC4_b2,
                                               self.nC4_b3, self.nC4_b4,
                                               self.nC10_w0, self.nC10_w1, self.nC10_w2, self.nC10_w3, self.nC10_w4,
                                               self.nC10_b0, self.nC10_b1,
                                               self.nC10_b2, self.nC10_b3, self.nC10_b4
                                               )
    ...
    def load_npANN(self):
        ...
        self.nC4_w0 = self.w_nC4[0].astype('float64')
        self.nC4_w1 = self.w_nC4[1].astype('float64')
        self.nC4_w2 = self.w_nC4[2].astype('float64')
        self.nC4_w3 = self.w_nC4[3].astype('float64')
        self.nC4_w4 = self.w_nC4[4].astype('float64')

        self.nC4_b0 = self.b_nC4[0].astype('float64')
        self.nC4_b1 = self.b_nC4[1].astype('float64')
        self.nC4_b2 = self.b_nC4[2].astype('float64')
        self.nC4_b3 = self.b_nC4[3].astype('float64')
        self.nC4_b4 = self.b_nC4[4].astype('float64')
        ...
        self.nC10_w0 = self.w_nC10[0].astype('float64')
        self.nC10_w1 = self.w_nC10[1].astype('float64')
        self.nC10_w2 = self.w_nC10[2].astype('float64')
        self.nC10_w3 = self.w_nC10[3].astype('float64')
        self.nC10_w4 = self.w_nC10[4].astype('float64')

        self.nC10_b0 = self.b_nC10[0].astype('float64')
        self.nC10_b1 = self.b_nC10[1].astype('float64')
        self.nC10_b2 = self.b_nC10[2].astype('float64')
        self.nC10_b3 = self.b_nC10[3].astype('float64')
        self.nC10_b4 = self.b_nC10[4].astype('float64')
    ...
    # Requires dtype=np.float64 for all variables
    @staticmethod
    @jit(nopython=True)
    def npnb_ANN_predict(x, w0, w1, w2, w3, w4, b0, b1, b2, b3, b4):
    ...
    def ln_phi_model_calc_np(self, a_mix, b_mix, b_i, sum_xjAij):
        ...
        y_hat_nC4 = self.npnb_ANN_predict(X_prepared_nC4,self.nC4_w0,self.nC4_w1,self.nC4_w2,self.nC4_w3,self.nC4_w4,self.nC4_b0,self.nC4_b1,self.nC4_b2,self.nC4_b3,self.nC4_b4)
        ...
        y_hat_nC10 = self.npnb_ANN_predict(X_prepared_nC10,self.nC10_w0,self.nC10_w1,self.nC10_w2,self.nC10_w3,self.nC10_w4,self.nC10_b0,self.nC10_b1,self.nC10_b2,self.nC10_b3,self.nC10_b4)
    ...
    #@profile
    @jit(nopython=True)
    def ln_phi_model_calc_npnb(a_mix, b_mix, b_i, sum_xjAij, min_attr_nC4, range_attr_nC4, range_label_nC4, min_label_nC4, min_attr_nC10, range_attr_nC10, range_label_nC10, min_label_nC10,
                               nC4_w0,nC4_w1,nC4_w2,nC4_w3,nC4_w4,nC4_b0,nC4_b1,nC4_b2,nC4_b3,nC4_b4,
                               nC10_w0,nC10_w1,nC10_w2,nC10_w3,nC10_w4,nC10_b0,nC10_b1,nC10_b2,nC10_b3,nC10_b4):

        X_prepared_nC4 = np.array([a_mix, b_mix, b_i[0], sum_xjAij[0]])
        X_prepared_nC10 = np.array([a_mix, b_mix, b_i[1], sum_xjAij[1]])

        # Get prediction nC4
        X_prepared_nC4 = (X_prepared_nC4 - min_attr_nC4) / range_attr_nC4

        y_hat_nC4 = npnb_ANN_predict_ooc(X_prepared_nC4,
                                          nC4_w0,
                                          nC4_w1,
                                          nC4_w2,
                                          nC4_w3,
                                          ...
                                          nC4_b3,
                                          nC4_b4)
        y_hat_nC4 = range_label_nC4 * y_hat_nC4 + min_label_nC4

        # Get prediction nC10
        X_prepared_nC10 = (X_prepared_nC10 - min_attr_nC10) / range_attr_nC10
        y_hat_nC10 = npnb_ANN_predict_ooc(X_prepared_nC10,
                                           nC10_w0,
                                           nC10_w1,
                                           nC10_w2,
                                           nC10_w3,
                                           ...
                                           nC10_b3,
                                           nC10_b4)
        y_hat_nC10 = range_label_nC10 * y_hat_nC10 + min_label_nC10
        return np.array([y_hat_nC4[0], y_hat_nC10[0]])


# Function out of class
@jit(nopython=True)
def npnb_ANN_predict_ooc(x, w0, w1, w2, w3, w4, b0, b1, b2, b3, b4):
    # x = np.array(x, dtype=np.float32)
    l0 = np.dot(x, w0) + b0
    l0 = np.where(l0 > 0, l0, l0 * 0.1)
    l1 = np.dot(l0, w1) + b1
