...
class pr:
    ...
    def stability_analysis(self, T, P, z, b_i, Am, tolSSSA, itSSSAmax, Nc, K, TolXz):
        ...
        global X_prepared_nC4
        global X_prepared_nC10
        X_prepared_nC4 = np.array([a_mix, b_mix, b_i[0], sum_xiAij[0]])
        X_prepared_nC10 = np.array([a_mix, b_mix, b_i[1], sum_xiAij[1]])
        ANN_numba_noargs()
    ...
    def load_npANN_global(self):
        # Load weights and biases
        self.w_nC4, self.b_nC4 = np.load(r'C:\Users\markz\OneDrive\Documents\PycharmProjects_desktop_backup\PycharmProjects\Ln_phi_model\Applied_model\numpy_relu\lnphi_nC4_T300-600_P5-100__100_4_20_100_20200916-112226\lnphi_nC4_T300-600_P5-100__100_4_20_100_20200916-112226_Konverted_weights.npz',
        ...
        global min_attr_nC4
        global range_attr_nC4

        global min_label_nC4
        global range_label_nC4

        global min_attr_nC10
        global range_attr_nC10

        global min_label_nC10
        global range_label_nC10

        # Store in np.float64 separately
        nC4_w0 = self.w_nC4[0].astype('float64')
        nC4_w1 = self.w_nC4[1].astype('float64')
        nC4_w2 = self.w_nC4[2].astype('float64')
        nC4_w3 = self.w_nC4[3].astype('float64')
        nC4_w4 = self.w_nC4[4].astype('float64')

        nC4_b0 = self.b_nC4[0].astype('float64')
        nC4_b1 = self.b_nC4[1].astype('float64')
        nC4_b2 = self.b_nC4[2].astype('float64')
        nC4_b3 = self.b_nC4[3].astype('float64')
        nC4_b4 = self.b_nC4[4].astype('float64')

        self.w_nC10, self.b_nC10 = np.load(
            r'C:\Users\markz\OneDrive\Documents\PycharmProjects_desktop_backup\PycharmProjects\Ln_phi_model\Applied_model\numpy_relu\lnphi_nC10_T300-600_P5-100__100_4_20_100_20200915-230243\lnphi_nC10_T300-600_P5-100__100_4_20_100_20200915-230243_Konverted_weights.npz',
            allow_pickle=True)['wb']

        nC10_w0 = self.w_nC10[0].astype('float64')
        nC10_w1 = self.w_nC10[1].astype('float64')
        nC10_w2 = self.w_nC10[2].astype('float64')
        nC10_w3 = self.w_nC10[3].astype('float64')
        nC10_w4 = self.w_nC10[4].astype('float64')

        nC10_b0 = self.b_nC10[0].astype('float64')
        nC10_b1 = self.b_nC10[1].astype('float64')
        nC10_b2 = self.b_nC10[2].astype('float64')
        nC10_b3 = self.b_nC10[3].astype('float64')
        nC10_b4 = self.b_nC10[4].astype('float64')

        # Load preprocessing and post-processing (forward and inverse transforms)
        min_attr_nC4 = self.attr_full_pipeline_nC4.named_transformers_.num.named_steps.min_max_scaler.data_min_
        range_attr_nC4 = self.attr_full_pipeline_nC4.named_transformers_.num.named_steps.min_max_scaler.data_range_

        min_label_nC4 = self.label_full_pipeline_nC4[0].data_min_
        range_label_nC4 = self.label_full_pipeline_nC4[0].data_range_

        min_attr_nC10 = self.attr_full_pipeline_nC10.named_transformers_.num.named_steps.min_max_scaler.data_min_
        range_attr_nC10 = self.attr_full_pipeline_nC10.named_transformers_.num.named_steps.min_max_scaler.data_range_

        min_label_nC10 = self.label_full_pipeline_nC10[0].data_min_
        range_label_nC10 = self.label_full_pipeline_nC10[0].data_range_
        return
...
def ANN_numba_noargs():
    # Transform x
    x = (X_prepared_nC4 - min_attr_nC4) / range_attr_nC4
    l0 = np.dot(x, nC4_w0) + nC4_b0
    l0 = np.where(l0 > 0, l0, l0 * 0.1)
    l1 = np.dot(l0, nC4_w1) + nC4_b1
    l1 = np.where(l1 > 0, l1, l1 * 0.1)
    l2 = np.dot(l1, nC4_w2) + nC4_b2
    l2 = np.where(l2 > 0, l2, l2 * 0.1)
    l3 = np.dot(l2, nC4_w3) + nC4_b3
    l3 = np.where(l3 > 0, l3, l3 * 0.1)
    l4 = np.dot(l3, nC4_w4) + nC4_b4
    y_hat_nC4 = range_label_nC4 * l4 + min_label_nC4

    x = (X_prepared_nC10 - min_attr_nC10) / range_attr_nC10
    l0 = np.dot(x, nC10_w0) + nC10_b0
    l0 = np.where(l0 > 0, l0, l0 * 0.1)
    l1 = np.dot(l0, nC10_w1) + nC10_b1
    l1 = np.where(l1 > 0, l1, l1 * 0.1)
    l2 = np.dot(l1, nC10_w2) + nC10_b2
    l2 = np.where(l2 > 0, l2, l2 * 0.1)
    l3 = np.dot(l2, nC10_w3) + nC10_b3
    l3 = np.where(l3 > 0, l3, l3 * 0.1)
    l4 = np.dot(l3, nC10_w4) + nC10_b4
    y_hat_nC10 = range_label_nC10 * l4 + min_label_nC10

    return y_hat_nC4, y_hat_nC10
...
if __name__ == "__main__":
    ...
    # Load models
    modelPath = [
        r'C:\Users\markz\OneDrive\Documents\logs\logs\scalars\lnphi_nC4_T300-600_P5-100__100_4_20_100_20200916-112226',
        r'C:\Users\markz\OneDrive\Documents\logs\logs\scalars\lnphi_nC10_T300-600_P5-100__100_4_20_100_20200915-230243'
    ]
    pipelinePath = [
        r'C:\Users\markz\OneDrive\Documents\logs\logs\scalars\lnphi_nC4_T300-600_P5-100__100_4_20_100_20200916-112226\full_pipeline_lnphi_nC4_T300-600_P5-100__100_4_20_100_.pkl',
        r'C:\Users\markz\OneDrive\Documents\logs\logs\scalars\lnphi_nC10_T300-600_P5-100__100_4_20_100_20200915-230243\full_pipeline_lnphi_nC4_T300-600_P5-100__100_4_20_100_.pkl'
    ]
    pr.load_ANN_model(modelPath, pipelinePath)

    # Load npANN weights and biases to global namespace
    pr.load_npANN_global()
