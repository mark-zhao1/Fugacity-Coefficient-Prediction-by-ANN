...
class train_lnphi:
    ...
    # Read using pandas
    def load_lnphi_data(self, lnphi_path):
        csv_path = os.path.join(lnphi_path, "single_positive_real_roots_only_20200821-125540.csv") # previously "data_const_T_20200716-230921.csv"
    ...
    def split_data(self):
        ...
        self.X_train, self.X_valid, self.y_train, self.y_valid = train_test_split(
            self.X_train_full, self.y_train_full, test_size=0.2, random_state=42)
